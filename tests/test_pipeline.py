...
def load_and_validate_data(D:\ESG (VCBIP)\Prescriptive-ESG-Engine\tests\Sample Data.csv) -> pd.DataFrame:
    df = pd.read_csv(D:\ESG (VCBIP)\Prescriptive-ESG-Engine\tests\Sample Data.csv)
